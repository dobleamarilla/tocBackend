interface objImprimirVenta { //req.numFactura, req.arrayCompra, req.total, req.visa, req.tiposIva, req.cabecera, req.pie, req.nombreTrabajador, req.impresora, req.infoClienteVip
    numFactura: number,
    arrayCompra: Cesta["lista"],
    total: number,
    tipoPago: string,
    tiposIva: Ticket["tiposIva"],
    cabecera: string,
    pie: string,
    nombreDependienta: string,
    tipoImpresora: string,
    infoClienteVip: Ticket["infoClienteVip"]
}
interface objEnviarDatafonoControlRespuesta {
    data: any,
    objTicket: Ticket
}

interface objImprimirCierre {
    calaixFet: number,

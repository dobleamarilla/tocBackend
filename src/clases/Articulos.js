...
const schArticulosTarifaEspecial = __importStar(require("../componentes/schemas/articulosTarifaEspecial"));
class Articulos {
    constructor() {
    ...
    getInfoArticulo(idArticulo) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.tecladoTarifaEspecial) {
                const infoArticulo = yield schArticulos.getInfoArticulo(idArticulo);
                if (infoArticulo) {
                    return infoArticulo;
                }
                else {
                ...
                const infoArticuloTarifaEspecial = yield schArticulosTarifaEspecial.getInfoArticuloTarifaEspecial(idArticulo);
